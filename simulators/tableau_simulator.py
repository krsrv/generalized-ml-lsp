"""
Copied from https://github.com/remmyzen/rlftqc/blob/main/rlftqc/simulators/tableau_simulator.py
"""
import jax.numpy as jnp

class TableauSimulator():
    """ A tableau simulator of batches Clifford circuits in parallel in Jax. The tableau is the one from
    Aaronson and Gottesman's paper, where given n generators, the tableau is of size (2n * 2n) + 2n and
    contains both stabilizers and destabilizers.
