...
class TokenProperties:
    ...
    def set_token_A_dims(self, eigval_trunc_dim: int | None) -> None:
        self.A_eigval_trunc_dim: int = (
            self.dA if eigval_trunc_dim is None else eigval_trunc_dim
        )
        assert (
            self.dA >= self.A_eigval_trunc_dim
