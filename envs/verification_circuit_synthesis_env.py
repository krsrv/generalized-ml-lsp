"""
Copied from https://github.com/remmyzen/rlftqc/blob/main/rlftqc/envs/verification_circuit_synthesis_env.py
"""
...
from utils import convert_qiskit_to_stim_circuit, is_css_code
import itertools
